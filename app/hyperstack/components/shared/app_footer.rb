class AppFooter < HyperComponent
  ...
  def links
    ...
    BR()
    A { "Join Slack chat" }.on(:click) { `window.open('https://join.slack.com/t/hyperstack-org/shared_invite/enQtNTg4NTI5NzQyNTYyLWQ4YTZlMGU0OGIxMDQzZGIxMjNlOGY5MjRhOTdlMWUzZWYyMTMzYWJkNTZmZDRhMDEzODA0NWRkMDM4MjdmNDE', "_blank");` }
    BR()
    ...
    BR()
    A { "Docs" }.on(:click) { `window.open('https://docs.hyperstack.org', "_blank");` }
    BR()
